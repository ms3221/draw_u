      ...
      <section className="relative z-10 py-24 px-6">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="space-y-5 text-[14px] text-[#555] leading-[1.9]">
            <p>
              <b className="text-[#2f2f2f]">드로우유</b>는 사용자의 온전한 공간이 될 수 있도록 사람과 생활에 집중하며,
              <br />
            ...
            <p>
              <b className="text-[#2f2f2f]">드로우유</b>는 공간을 완성시키기 위한 설계와 시공 과정,
              <br />
            ...
            <p>
              <b className="text-[#2f2f2f]">드로우유</b>는 사용자의 피드백을 최우선 아젠다로 두고 프로젝트를 계획하고 진행할 것이며,
              <br />
